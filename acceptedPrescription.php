...
$query = "SELECT * FROM prescriptions WHERE Status='ACCEPTED' ORDER BY InTime DESC";
...
<body>
        ...
        <?php
		$page="acceptedPrescription";
		include 'includes/sidebar.php'
		?>
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="container mt-5">
            <center><h1 class="mb-4">Accepted Prescriptions</h1></center>
